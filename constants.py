...
**重要:** チケットの「説明」部分は、必ず参照するRedmineチケットの「説明」と同じフォーマット・構成・スタイル（見出し、箇条書き、表など）を使用してください。勝手に構成を変更したり、省略したりしないでください。
...
**説明:**
[説明文]
※ 参照チケットのフォーマットを遵守すること

**注意事項:**
[必要に応じて注意事項を記載]

# ルール
1. 参照チケットの「説明」のフォーマット（見出しや記述スタイル）を完全に模倣してください
2. 内容は新しいチケットの目的に合わせて適切に変更してください
3. 「題名」も参照チケットの命名規則に合わせてください
"""
